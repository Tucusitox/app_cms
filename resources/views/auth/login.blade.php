<x-LayoutLogins tittle="Inicia sesión">
    ...
    <div class="border border-2 border-success rounded p-5 mt-3" style="box-shadow: 10px 10px 10px rgba(62, 62, 62, 0.5);">
        ...
        <form action="{{ route('autenticar.index') }}" method="POST" id="formLogin">
            ...
            <a class="btn btn-success mt-3" href="#">Registrate</a>
